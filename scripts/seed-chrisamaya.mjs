...
const HOMEPAGE_BLOCKS = [
  ...
  ['calculator', 5, { section_title: 'Engineering Resources', links: [{ label: 'Open calculators', href: '/resources/calculators', description: 'ROAS, CAC, LTV, and growth modeling resources.' }] }],
  ['survey', 6, { section_title: "Let's Build It Right.", primary_label: 'Fill out the strategy form above', primary_href: '#audit', secondary_label: 'book a technical audit', secondary_href: '/audit', connector: 'or' }],
];
...
const CORE_PAGES = [
  ...
  ['resources/calculators', 'Calculators | Chris Amaya', [['hero', { badge: 'TOOLS', headline: 'Growth Calculators', subhead: 'ROAS, CAC, LTV, and more.', cta_label: 'Start Calculating', cta_href: '#calculators' }], ['calculator', { section_title: 'Engineering Resources', links: [{ label: 'Jumpstart Scaling Calculators', href: 'https://jumpstartscaling.com/resources/calculators', description: 'Interactive calculator hub.' }, { label: 'Book custom calculator build', href: '/contact', description: 'Need a custom tool for your funnel?' }] }]]],
