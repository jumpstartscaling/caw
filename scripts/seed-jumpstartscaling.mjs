...
const THEME = {
  ...
  nav: {
    ...
    growth_tools: [
      ...
      { name: 'Insights Explorer', href: '/insights' },
    ],
    solutions: [
      { name: 'All Solutions', href: '/solutions' },
      { name: 'Paid Acquisition', href: '/solutions/paid-acquisition' },
      { name: 'Funnel Architecture', href: '/solutions/funnel-architecture' },
      { name: 'CRM Transformation', href: '/solutions/crm-transformation' },
      { name: 'Data Attribution', href: '/solutions/data-attribution' },
      { name: 'Authority Engine', href: '/solutions/authority-engine' },
      { name: 'Growth Retainer', href: '/solutions/growth-retainer' },
    ],
    locations: [
...
const pages = [
  {
    ...
    blocks: [
      ...
      },
      {
        block_type: 'survey',
        data: {
          section_title: 'Quick Growth Survey',
          intro: 'Answer a few questions and we will route you to the right growth plan.',
          submit_label: 'Get My Plan',
          submit_source: 'JumpstartScaling_HomeSurvey',
          form_type: 'growth_survey',
          questions: [
            {
              id: 'business_type',
              type: 'single',
              label: 'What type of business are you scaling?',
              options: ['E-Commerce', 'B2B / SaaS', 'Service Agency', 'Local Business'],
              required: true,
            },
            {
              id: 'monthly_revenue',
            ...
            },
            {
              ...
              type: 'single',
              label: 'What is your primary bottleneck right now?',
              options: ['Lead generation', 'Funnel conversion', 'CRM follow-up', 'Attribution clarity'],
              required: true,
            },
            {
              id: 'name',
            ...
            },
            {
              id: 'email',
              type: 'email',
              label: 'Best email for your roadmap',
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        block_type: 'audit_survey',
        data: {
          section_title: 'Moat Strength Survey',
          intro: 'Complete this diagnostic to receive a priority-ranked execution roadmap.',
          submit_label: 'Submit Audit',
          submit_source: 'JumpstartScaling_AuditSurvey',
          form_type: 'moat_audit_survey',
          questions: [
            {
              id: 'acquisition_predictability',
              type: 'single',
              label: 'How predictable is acquisition right now?',
              options: ['Highly unstable', 'Somewhat predictable', 'Predictable with variance', 'Very predictable'],
              required: true,
            },
            {
              id: 'conversion_efficiency',
              type: 'single',
              label: 'How would you rate funnel conversion efficiency?',
              options: ['Poor', 'Average', 'Strong', 'Best-in-class'],
              required: true,
            },
            {
              id: 'crm_maturity',
              type: 'single',
              label: 'How mature is your CRM follow-up system?',
              options: ['Mostly manual', 'Partially automated', 'Well automated', 'Fully orchestrated'],
              required: true,
            },
            {
              id: 'attribution_confidence',
              type: 'single',
              label: 'How confident are you in attribution data?',
              options: ['Low confidence', 'Partial confidence', 'Mostly trusted', 'Fully trusted'],
              required: true,
            },
            {
              id: 'timeline',
              type: 'single',
              label: 'When do you want to implement changes?',
              options: ['Immediately', 'Within 30 days', 'Within 90 days', 'Researching'],
              required: true,
            },
            {
              id: 'name',
